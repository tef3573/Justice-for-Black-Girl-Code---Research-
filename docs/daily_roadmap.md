...
- Establish safe data and output directories
- Record the approved study design
- Document the staged research and development roadmap

## Milestone 2 — Exact NLSY97 extraction specification

- Resolve every required variable to its NLSY97 reference number
- Create an uploadable NLS Investigator tagset
- Document rounds and weights
- Mark public versus restricted variables
